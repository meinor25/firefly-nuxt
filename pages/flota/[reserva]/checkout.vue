            ...
            <div class="forma">
                ...
                <fieldset>
                    ...
                    <p>
                        ...
                        <Field
                            v-model="pedido.cliente.apellido"
                            type="text"
                            id="apellido"
                            name="apellido"
                            rules="required"
                    ...
                    <p>
                        ...
                        <Field
                            v-model="pedido.cliente.telefono"
                            type="text"
                            id="telefono"
                            name="telefono"
                    ...
                    <p>
                        ...
                        <Field
                            v-model="pedido.cliente.licencia"
                            type="text"
                            id="licencia"
                            name="licencia"
                            rules="required"
                    ...
                    <p>
                        ...
                        <date-picker
                            ...
                            v-model="pedido.cliente.nacimiento"
                            locale="es"
                            name="nacimiento"
                            rules="required"
                            id="nacimiento"
                ...
                <div
                    class="reserva"
                    v-if="storePedido.pedido.reserva === 'reserva'"
                >
                    <button type="submit" @click="storeNoPago.onSubmit">
                        Reservar
                    </button>
                </div>
                ...
                <div
                    class="reserva"
                    v-if="storePedido.pedido.reserva === 'prepago'"
                >
                    <button
                        type="submit"
                        @click="storeCheckout.metodos = 'metodos'"
                    >

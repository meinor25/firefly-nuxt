...
export const useCheckoutStore = defineStore("checkout", () => {
    ...
    const [nombre, apellido, email, telefono, licencia, nacimiento] =
        useFieldModel([
            "nombre",
            "apellido",
            "email",
                ...
                var items: Pedido[] = [
                    {
                        ...
                        fecha_retiro: moment(
                            storePedido.pedido.diaRetiro
                        ).format(),
                        retorno: storePedido.pedido.sucursalRetorno.name,
                        fecha_retorno: moment(
                            storePedido.pedido.diaRetorno
                        ).format(),
                        ...
                        sucursal_retorno_detail:
                            storePedido.pedido.sucursalRetorno,

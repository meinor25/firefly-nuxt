                    ...
                    <article>
                        ...
                        <footer v-if="storePedido.pedido.carro.tipo != 'Sedan'">
                            <input
                                ...
                                type="radio"
                                name="cobertura"
                                v-model="storePedido.pedido.cobertura"
                                :value="cobertura"
                            />
                            <h4>B/. {{ cobertura.precio_2 }}</h4>
                            <em>por día</em>
                        </footer>
                        <footer v-else>
                            <input
                ...
                <li>
                    <article>
                        <div>
                            ...
                            <p>
                                Esta cobertura ofrece a EL ARRENDATARIO los
                                siguientes servicios de asistencia en carretera
                                sin cargo alguno: Pérdida de llave del
                                automóvil, servicio de grúa, reemplazo de
                                neumático, asistencia al quedarse sin
                                combustible o sin batería. El tiempo de
                                respuesta por parte de LA ARRENDADORA está
                                sujeto al día, hora y ubicación del incidente.
                            </p>
                        </div>
                        <footer class="era">
                            <h4>B/. 3.99</h4>
